...
<body class="hold-transition login-page">
  <div class="login-box">
    <div class="login-logo">
     ...
     src="<?= isset($logo_url) ? base_url('img/settings/' . $logo_url) : '' ?>"
     alt="logo_resim">


      <!--<a href="#"><b><?php if (isset($data['companyName'])) {
    ...
    <div class="card">
      ...
      <i>
        <p class="login-box-msg" style="text-align:center; color:gray;">-SolutionSoftware-</p>
      </i>
      </form>
